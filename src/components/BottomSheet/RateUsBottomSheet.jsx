...
const RateUsBottomSheet = ({ visible, closeModal }) => {
  ...
  return (
                    ...
                    >
                      <Image
                        style={{
                          ...
                          height: 48,
                          tintColor:
                            rating.id <= selectedRating ? "#FFAB48" : "#585868",
                        }}
                        source={RateUsStart}
                        resizeMode={"contain"}
                      />
                  ...
                  <View style={{ marginTop: "8%" }}>
                    ...
                    <View
                      style={[
                        ...
                        layout.itemsCenter,
                        styles.inputField,
                        { paddingHorizontal: 10, marginTop: "5%", height: 90 },
                      ]}
                    >
                      <TextInput
                        style={[
    ...
    <ThanksForFeedbackBottomSheet closeModal={closeThanksForFeedbackModal} visible={thanksForYourFeedbackBottomSheetVisible} />
    </View>
  );
};
