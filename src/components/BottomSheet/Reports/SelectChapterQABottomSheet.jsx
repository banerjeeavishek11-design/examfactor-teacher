...
const SelectChapterQABottomSheet = ({visible, closeModal}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <SelectQuestionTypeBottomSheet selectedChapter={selectedChapter} visible={openQuestionTypeModal} closeModal={closeQuestionTypeModal} />
    </View>
  )
}
